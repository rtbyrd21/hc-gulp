var app = angular.module('hcApp', ['ngResource', 'filters', 'ngRoute', 'appRoutes', 'ui', 'ui.filters', 'xeditable', 'customFilters', 'theFilters', 'textAngular', 'myApp.directives', 'ngSanitize', 'google-maps'.ns()]);
